    ...
    try {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
             det = det + "<tr>   <td><input type='button' value='Editar' class='btn btn-primary otherButton' data-toggle='modal' data-target='#modal_obs'  "
                    + "   ></td>"
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("fecha")  + "</b>    </td> "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("cod_carrito")  + "   </b></td>"
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("origen")  + "   </b></td>"
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("tipo_huevo")  + "    </b></td>"
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("categoria")  + "    </b></td>"
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("fecha_puesta")  + "    </b></td>"
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("hora_clasificacion")  + "    </b></td>"
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("resp_clasificacion")  + "   </b></td>  "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("u_medida")  + "   </b></td>  "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getInt("cantidad")  + "   </b></td>  "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("aviario")  + "   </b></td>  "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("empacadora")  + "  </b></td>  "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("tipo_almacenamiento")  + "   </b></td> "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("liberado_por")  + "  </b></td>  "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("comentario")  + "  </b></td>  "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("estado_liberacion")  + "  </b> </td> "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("disposicion")  + "   </b></td> "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getString("estado")  + "  </b></td> "
                    + "<td><b>" +   jsonArray.getJSONObject(i).getInt("cod_interno")  + "  </b></td> "
                    + "</tr>";
          }
