...
<%     
 ...
 try {
    ...
    ResultSet rs,rs2,rs3,rs5,rsRef;
    String grilla_html="";
     ...
     String cabecera="   "
         ...
         rsRef = fuente.obtenerDato(" exec mae_log_stock_pedidos_maehara_3  @tipo=1 ,@id_pedido=0 ");
     
      while(rsRef.next())
        {
            //grilla_html=grilla_html+rsRef.getString("tr");
         }
