    ...
    String grilla_html="";
     ...
     String cabecera="   "
      ...
      while(rs.next())
        ...
        rs2 = fuente.obtenerDato("      select id_camion from mae_log_preembarque_reserva where estado=2  group by id_camion ");
        ...
        {                        
         ...
         rs5 = fuente.obtenerDato("      select cod_carrito from mae_log_preembarque_reserva where estado=2 and cod_carrito<>0 and id_camion="+id_camion +"");
