     ...
     try 
     {
        ...
        float cantidad =0; 
         rs = st.executeQuery("  select *,b.descripcion as desc_estado,"
                ...
                + " from mae_bal_mtp_cab_solicitud a inner join mae_bal_estados b on a.estado=b.id "
                + " where CONVERT(DATE,FECHA_REGISTRO) BETWEEN CONVERT(DATE,'"+desde+"')  AND  CONVERT(DATE,'"+hasta+"') and a.id_usuario="+ id_usuario+"   ");
