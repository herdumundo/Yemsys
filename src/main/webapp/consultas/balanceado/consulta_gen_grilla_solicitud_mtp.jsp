...
<%    
    ...
    DecimalFormat formatea = new DecimalFormat("###,###.##");
     ...
     try 
     {
        ...
        cabecera = " <table id='tb_formulacion' class='   table-bordered   table-hover   compact ' >"
                + "<thead>"
                + "<tr >"
        ...
        String td_diferencia="Disminución "+puntualOmensual +" : "+formatea.format(((cantidad_actual-cantidad_nueva)/1000)*tonelada)+"<i class='nav-icon fas fa-arrow-circle-down text-blue' aria-hidden='true'></i>";
