...
<%
      ...
      PreparedStatement pt = clases.controles.connect.prepareStatement("select mor_fila, mor_cant,mor_lote,mor_aviario,mor_id  from ppr_mortandad where mor_fecha='" + fecha + "' "
      ...
      PreparedStatement pt3 = clases.controles.connect.prepareStatement("select dl_fecha,(select dl_id  from ppr_datolotes where dl_fecha='" + fecha + "' and dl_aviario='" + aviario + "' ) as dl_id  "
      + "from ppr_datolotes where dl_fecha = dateadd(DAY,-1,convert(date,'" + fecha + "') ) and dl_aviario='" + aviario + "'");
