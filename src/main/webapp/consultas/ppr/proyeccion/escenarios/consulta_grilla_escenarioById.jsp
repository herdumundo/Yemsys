...
<%    StringBuilder tabla = new StringBuilder();
    ...
    try {
        ...
        PreparedStatement pst = connection.prepareStatement("select isnull(p_parametro_general,'') as p_parametro_general,isnull(m_parametro_general,'') as m_parametro_general,p_padron_id,m_padron_id ,escenario_id,raza_name,escenario_nombre,periodo,calculo_mortandad,padron_mortandad, ISNULL(m_recria,0) as m_recria, ISNULL(m_produccion_primaria,0) as m_produccion_primaria , ISNULL(m_pre_descarte,0) as m_pre_descarte , ISNULL(calculo_produccion,0) as calculo_produccion , ISNULL(padron_produccion,0) as padron_produccion, ISNULL(p_recria,0) as p_recria, ISNULL(p_produccion_primaria,0) as p_produccion_primaria, ISNULL(p_pre_descarte,0) as p_pre_descarte from v_ppr_escenario_det  where escenario_id=" + id + " ");
        ...
        tabla.append("<th colspan='15' style='text-align: center;'>" + nombre + "</th>");
        tabla.append("</tr>");
        tabla.append("<tr>");
        ...
        while (rs.next()) {
            ...
            PreparedStatement pstPadronMortandad = connection.prepareStatement(" select * from ppr_padrones   ORDER BY CASE WHEN padron_id = " + rs.getString("m_padron_id") + "  THEN 0 ELSE 1 END, padron_id    ");
            ...
            PreparedStatement pstPadronProduccion = connection.prepareStatement(" select * from ppr_padrones ORDER BY CASE WHEN padron_id = " + rs.getString("p_padron_id") + "  THEN 0 ELSE 1 END, padron_id ");
        ...
        tablaLotes.append("</tr>");        tablaLotes.append("<tr>");
