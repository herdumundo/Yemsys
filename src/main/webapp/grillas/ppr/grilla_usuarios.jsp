...
<div class="float-right d-none d-sm-inline-block" href="#" data-toggle="modal" data-target=".bd-example-modal-xx"
    ...
    String area=                    (String) sesionOk.getAttribute("clasificadora");
       ...
       PreparedStatement ps=clases.controles.connect.prepareStatement(query);
       ResultSet rs=ps.executeQuery();
 
       PreparedStatement ps2=clases.controles.connect.prepareStatement("select * from mae_yemsys_roles");
       ResultSet rs2=ps2.executeQuery();
       
       PreparedStatement ps3=clases.controles.connect.prepareStatement("select * from mae_yemsys_areas");
       ResultSet rs3=ps3.executeQuery();
       
       PreparedStatement ps4=clases.controles.connect.prepareStatement("select * from tab_mae_ppr_estados where id in (1,2)");
