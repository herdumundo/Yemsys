...
<%    String responseString = "";
    ...
    try {
        ...
        String destinoNuevo   = request.getParameter("nuevoDestino");
        String usuario  = (String) sesionOk.getAttribute("nombre_usuario");

        // Create an instance of HttpClient
        HttpClient httpClient = HttpClientBuilder.create().build();
        HttpPost requests = new HttpPost("http://localhost:8000/maehara/ptcCrearReprocesosCancelacionTransferenciaLotes");
        ...
        requestBody.put("destino", destinoNuevo);
        ...
        { 
            tipoMensaje = jsonObj.getInt("estado_registro") ;
