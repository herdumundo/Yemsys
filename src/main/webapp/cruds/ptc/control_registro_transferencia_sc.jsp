...
<%   
    ...
    {
        sourceDataTable.addRow(lotes.cod_carrito,lotes.cantidad, lotes.cod_interno );
    }
    try 
    {
        ...
        callableStatement .setString(8, "SC");
        callableStatement .setObject(9, sourceDataTable);
