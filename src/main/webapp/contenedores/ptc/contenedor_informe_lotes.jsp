...
<div class="col-lg-20 ">
    <div class="position-relative p-3 bg-navy"  >
        ...
        <center><b>INFORME LOTES VIMAR</b></center>
    </div>
</div>

<label for="fecha">Ingrese fecha desde:</label>
    <input type="text" class="datepicker" id="fecha_desde" name="fecha">
    
<label for="fecha">hasta:</label>    
    <input type="text" class="datepicker" id="fecha_hasta" name="fecha">

<button id="btnInforme" class="btn btn-danger" style="width: 100%; display: block;" onclick="generarInformeLotes()">Buscar</button>

<div id="informe_lotes">
