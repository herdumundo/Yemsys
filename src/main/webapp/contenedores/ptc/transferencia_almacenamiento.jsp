...
<div class="col-lg-20 ">
    <div class="position-relative p-3 bg-navy"  >
        ...
        <center><b>REGISTRO TRANSFERENCIAS PARA ALMACENAMIENTO</b></center>
    </div>
</div>  <br>    
...
<div class="form-group">
    <div class="input-group">
        ...
        <span class="input-group-addon">-</span>
        <input type="button" value="INGRESAR" name="btn_ingresar" id="btn_ingresar" onclick="consulta_lotes_ALMACENAMIENTO($('#txt_lote').val());" class="form-control btn btn-primary"/>
