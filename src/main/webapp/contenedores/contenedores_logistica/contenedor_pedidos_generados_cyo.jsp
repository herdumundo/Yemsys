...
<%
    ...
    rs = st.executeQuery(" 	select id,fecha_registro,camion,sum(cantidad) as cantidad,id_camion,id_chofer from "
            ...
            + "  where a.estado in (1,2,3) and a.clasificadora='" + area + "' "
            ...
            + "	inner join maehara.dbo.[@CAMIONES] b     on a.id_camion=b.Code collate database_default     and a.estado IN (1,2,3)    "
            + "	inner join mae_log_ptc_det_pedidos2 c on a.id=c.id_cab and c.estado in (1,2,3) and c.clasificadora='" + area + "' "
